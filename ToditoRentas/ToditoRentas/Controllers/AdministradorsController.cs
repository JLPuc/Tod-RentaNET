...
namespace ToditoRentas.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdAdministrador,Nombre,Apellido,CorreoElectronico,Usuario,Contrasena,NumeroCelular,NumeroFijo,Rol,Status")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdAdministrador,Nombre,Apellido,CorreoElectronico,Usuario,Contrasena,NumeroCelular,NumeroFijo,Rol,Status")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
